...
Four balls each with a different number drop from the top of the display and a mathematical problem will be prompted on the top (Example : 1+2). The way the player scores is by collecting the ball with the right answer on it (here : 3), in the box.
